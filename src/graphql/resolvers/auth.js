...
module.exports = {
    userSignUp: async function (args) {
        try {
            ...
            if (!userData) {
                return errorResponse(false, null, [{type: 'account', message: 'Account creation failed.', code: 422}]);
            }
    ...
    userLogin: async function (args) {
        try {
            ...
            if (!user) {
                return errorResponse(false, null, [{type: 'authenticate', message: 'Invalid credentials.', code: 401}]);
            }
